...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   ...
   I would say that semantic tags make it clear to the browser what the meaning of a page and its content is. That clarity is also communicated with search engines, ensuring that the right pages are delivered for the right queries.
...
4. Explain why git is valuable to a team of developers.
   ...
   Git is useful for a team because it allows you to easily share code, help catch errors easier
   and because of the ability of version control.

5. Define mobile-first design in your own words.

   Most users are using their phones to go to websites over using a computer. Since mobile gets
   more traffic we should make sure mobile is on point before anything else.
